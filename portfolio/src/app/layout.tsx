...
export const metadata: Metadata = {
  ...
  description: 'Portfolio website showcasing my work in AI product management and software development',
  keywords: ['Lawrence Hua', 'AI Product Manager', 'Software Development', 'Portfolio', 'Product Management'],
  authors: [{ name: 'Lawrence Hua' }],
  creator: 'Lawrence Hua',
  publisher: 'Lawrence Hua',
  openGraph: {
    title: 'Lawrence Hua - AI Product Manager',
    description: 'Learn more about Lawrence - AI Product Manager and Software Developer',
