...
import { FiUser, FiCpu, FiImage, FiFile } from "react-icons/fi";
  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 py-3">
      ...
      {isLoading && (
        ...
        >
          <div className={`${styles.messageBubble} ${styles.assistant} flex items-start gap-2`}>
            {/* Avatar */}
            <div
              className={`flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center ${
                isLoveMode
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className={`${styles.loadingMessage} flex items-center gap-2`}>
