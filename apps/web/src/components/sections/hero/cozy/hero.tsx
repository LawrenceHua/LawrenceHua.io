...
function Hero() {
  return (
    <MotionWrap className="flex min-h-[calc(100dvh-(--spacing(14)))] w-full items-center justify-center py-8 sm:py-12">
      <div className="grid items-center justify-center gap-6 px-4 md:grid-cols-2 md:px-6 lg:gap-10">
        <div className="space-y-4 text-center md:text-left">
          ...
          <TextReveal
            as="p"
            className="mx-auto max-w-[600px] text-sm text-gray-500 sm:text-base md:text-lg lg:text-xl dark:text-gray-400"
          >
            {hero.description}
          </TextReveal>
          <div className="flex justify-center gap-4 pt-2 md:justify-start">
            <a
              href="https://linkedin.com/in/lawrence-hua"
              target="_blank"
              rel="noopener"
              aria-label="LinkedIn"
            ...
            >
              <svg
                ...
                height="24"
                fill="currentColor"
                className="text-blue-700 hover:text-blue-900 sm:h-7 sm:w-7"
              >
            ...
            >
              <svg
                ...
                height="24"
                fill="currentColor"
                className="text-gray-800 hover:text-black sm:h-7 sm:w-7"
              >
            ...
            <a
              href="https://expiredsolutions.com"
              target="_blank"
              rel="noopener"
              aria-label="Expired Solutions"
              className="p-2 transition-transform hover:scale-110"
            >
              <svg
                width="24"
                height="24"
                fill="currentColor"
                className="text-green-700 hover:text-green-900 sm:h-7 sm:w-7"
              >
                <circle
                  cx="12"
                  cy="12"
        ...
        <div className="flex justify-center">
          <Image
            ...
            className="aspect-square h-48 w-48 overflow-hidden rounded-full border-4 border-blue-500 object-cover object-center shadow-lg sm:h-56 sm:w-56 md:h-60 md:w-60"
            height="240"
            width="240"
            src={"/images/hero.jpg"}
            priority
